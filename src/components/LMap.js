...
import { fetchMaskInformation } from '../actions'
    ...
    return (
        <div >
            <Map center={position} zoom={zoom} maxZoom={20}>
                ...
                <MarkerClusterGroup>
                    {props.maskInformationLists.map((data, index) =>
...
export default connect(mapStateToProps, mapDispatchToProps)(LMap);